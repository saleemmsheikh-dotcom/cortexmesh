# CortexMesh — Intent, Repository, and Decision Scope Policy

Version: 1.1

Status: Working vision and policy document

Classification: DRAFT FOR BOARD REVIEW

Supersedes: cortexmesh-policy-intent-repository_v1.0.md

---

# Revision Summary

Version 1.1 incorporates seven amendments approved unanimously during Session 7.5/8 policy review.
...
This document contains multiple categories of content.

These classifications are intended to assist review and ratification activities.

| Classification       | Meaning                                                                      |
| -------------------- | ---------------------------------------------------------------------------- |
| [NORMATIVE POSITION] | Governance intent, policy rationale, scope, or principle                     |
| [MECHANISM PROPOSAL] | Operational mechanism requiring feasibility, implementation, or audit review |
| [HYBRID]             | Contains both normative and mechanism content                                |
| [OPEN QUESTION]      | Explicitly unresolved by design                                              |
| [DEFERRED]           | Deferred to another governance or engineering body                           |

The classification of a section does not imply ratification status.

It identifies the primary review lens that should be applied by reviewers.

---

# Board-Approved Amendments Included

A-01 Section Classification Appendix

A-02 Auxiliary System Clarification (Model A)

A-03 Safety Language Clarification

A-04 Amendment Process Placeholder

A-05 External Artifact Governance Requirement

A-06 Title Metadata Enforcement

A-07 Institutionalized vs Empirical Inference Clarification

---

# Amendment Process Placeholder

Until a formal governance amendment process is established, policy amendments require:
...
# External Artifact Governance Status

Any external artifact referenced as load-bearing by this policy shall have a documented governance status.
...
## 0. What CortexMesh Is Not [NORMATIVE POSITION]
...
## 1. Domain Scope [NORMATIVE POSITION]
...
## 2. The Three Determining Variables [HYBRID]
...
## 3. Intention Is Elicited, Not Inferred [MECHANISM PROPOSAL]
...
## 4. The Historical Repository [HYBRID]
...
### 4.1a Randomized Per-Query Agent Identifiers [MECHANISM PROPOSAL]
...
### 4.5 Function [NORMATIVE POSITION]
...
### 4.6 Authority [NORMATIVE POSITION]
...
### 4.9 Draft-to-Final Lifecycle [MECHANISM PROPOSAL]
...
### 4.12 Three-Vault Architecture [HYBRID]
...
**Auxiliary System Clarification — Model A:** Auxiliary-system outputs are external artifacts. They may be downloaded, stored, or reviewed by the client outside CortexMesh, but they may not be reintroduced into CortexMesh workflows, the client's agent flow within CortexMesh, repository retrieval, annexe generation, or any vault-to-vault comparison pathway. The auxiliary system remains separate by design and is not a backchannel into CortexMesh decision production.

**Institutionalized vs Empirical Inference:** This policy distinguishes institutionalized inference from client-side empirical inference. Institutionalized inference means CortexMesh, its repository, its vault access layer, or its governed workflows compute, retain, surface, or reuse patterns across requests as part of system operation. That is prohibited unless expressly authorized by future policy. Client-side empirical inference means a client reads separately retrieved artifacts outside CortexMesh and forms their own conclusion. That client-side reasoning is outside CortexMesh, but it does not authorize CortexMesh to ingest, store, summarize, or operationalize the resulting inference.
...
**Identifier-only title enforcement:** Request titles must be treated as identifiers only. Titles must not contain outcome commentary, evaluative content, substantive case summaries, client profiling signals, or any text intended to guide future interpretation. CortexMesh must not provide aggregate title views, title analytics, title search across cases, or any interface that would let titles become a de facto activity log. Any future implementation must enforce this through input validation, UI constraints, or equivalent technical controls rather than relying only on user guidance.
...
## 5. Further Constraints on Interpretation [NORMATIVE POSITION]
...
## 6. The Accuracy/Innovation Dilemma — Stated, Not Resolved Away [NORMATIVE POSITION]
...
## 7. Why No Aggregate Metrics — Explicit Rationale [NORMATIVE POSITION]
...
## 8. Why Confirmation and a Draft Stage Matter Beyond Intent-Reading [HYBRID]
...
**Safety language clarification:** CortexMesh does not prevent harm. CortexMesh introduces procedural safeguards intended to reduce specific classes of risk.

---

## 9. Open / Deferred [OPEN QUESTION]
...
### Amendment Process Placeholder [MECHANISM PROPOSAL]
...
### External Artifact Governance Status [MECHANISM PROPOSAL]
...
## Appendix A — Section Classification Register [NORMATIVE POSITION]
...
| 3. Intention Is Elicited, Not Inferred | [MECHANISM PROPOSAL] |
| 4. The Historical Repository | [HYBRID] |
| 4.1 The Processing Layer | [MECHANISM PROPOSAL] |
| 4.1a Randomized Per-Query Agent Identifiers | [MECHANISM PROPOSAL] |
| 4.2 Multi-Agent Consensus | [DEFERRED] |
| 4.3 Vault Custody | [DEFERRED] |
| 4.4 Agent Vetting | [NORMATIVE POSITION] |
| 4.5 Function | [NORMATIVE POSITION] |
| 4.6 Authority | [NORMATIVE POSITION] |
| 4.7 Activation | [MECHANISM PROPOSAL] |
| 4.8 Output Form | [MECHANISM PROPOSAL] |
...
| 4.13 Request Index | [HYBRID] |
| 5. Further Constraints on Interpretation | [NORMATIVE POSITION] |
| 6. The Accuracy/Innovation Dilemma | [NORMATIVE POSITION] |
| 7. Why No Aggregate Metrics | [NORMATIVE POSITION] |
| 8. Confirmation and Draft Stage | [HYBRID] |
| 9. Open / Deferred | [OPEN QUESTION] |
| Appendix A | [NORMATIVE POSITION] |

The register is a review aid. Classification identifies the primary review lens and does not by itself establish ratification status.
