# EXP-001 - Baseline Characterization of the Phase 2C Reference Orchestration Engine
...
Establish the first fully reproducible research characterization of the sealed reference engine using Certified Replay Corpus v1.1 and the Phase 3A validation framework.

This experiment observes. It does not improve, optimize, outperform, prove, adapt, or integrate the engine.
...
- `EXP-001_LIMITATIONS.md` will preserve scope and validity limits.
- `EXP-001_REPRODUCIBILITY_PACKAGE.md` defines and indexes the immutable reproduction bundle.
